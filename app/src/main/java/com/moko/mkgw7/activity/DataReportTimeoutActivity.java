...
import com.moko.mkgw7.databinding.ActivityDataReportTimeoutMkgw7Binding;
...
public class DataReportTimeoutActivity extends BaseActivity<ActivityDataReportTimeoutMkgw7Binding> {
    ...
    @Override
    protected ActivityDataReportTimeoutMkgw7Binding getViewBinding() {
        return ActivityDataReportTimeoutMkgw7Binding.inflate(getLayoutInflater());
    }
