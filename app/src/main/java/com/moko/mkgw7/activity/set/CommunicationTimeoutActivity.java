...
import com.moko.mkgw7.databinding.ActivityCommunicationTimeoutMkgw7Binding;
...
public class CommunicationTimeoutActivity extends BaseActivity<ActivityCommunicationTimeoutMkgw7Binding> {
    ...
    @Override
    protected ActivityCommunicationTimeoutMkgw7Binding getViewBinding() {
        return ActivityCommunicationTimeoutMkgw7Binding.inflate(getLayoutInflater());
    }
