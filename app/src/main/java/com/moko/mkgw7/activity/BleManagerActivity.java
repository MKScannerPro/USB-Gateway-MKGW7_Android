...
public class BleManagerActivity extends BaseActivity<ActivityBleDevicesMkgw7Binding> implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    @Override
    protected ActivityBleDevicesMkgw7Binding getViewBinding() {
        return ActivityBleDevicesMkgw7Binding.inflate(getLayoutInflater());
    }
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools20D.getInstance(BleManagerActivity.this).selectDevice(mMokoDevice.mac);
