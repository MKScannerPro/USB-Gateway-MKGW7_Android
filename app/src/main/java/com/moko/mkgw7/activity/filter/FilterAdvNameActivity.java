...
import com.moko.mkgw7.databinding.ActivityFilterAdvNameMkgw7Binding;
...
public class FilterAdvNameActivity extends BaseActivity<ActivityFilterAdvNameMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterAdvNameMkgw7Binding getViewBinding() {
        return ActivityFilterAdvNameMkgw7Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_ADV_NAME) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterAdvNameActivity.this).inflate(R.layout.item_adv_name_filter_mkgw7, mBind.llDavName, false);
                    ...
                    title.setText(String.format(Locale.getDefault(),"ADV Name%d", index));
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.item_adv_name_filter_mkgw7, mBind.llDavName, false);
        TextView title = v.findViewById(R.id.tv_adv_name_title);
