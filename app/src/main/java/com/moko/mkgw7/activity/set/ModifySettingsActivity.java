...
public class ModifySettingsActivity extends BaseActivity<ActivityModifySettingsMkgw7Binding> {
    ...
    @Override
    protected ActivityModifySettingsMkgw7Binding getViewBinding() {
        return ActivityModifySettingsMkgw7Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.CONFIG_MSG_ID_REBOOT) {
            ...
            if (result.result_code == 0) {
                ...
                mBind.tvName.postDelayed(() -> {
                    ...
                    // 跳转首页，刷新数据
                    Intent intent = new Intent(ModifySettingsActivity.this, MkGw7MainActivity.class);
