...
import com.moko.support.mkgw7.entity.BleConnectedList;
...
public class DeviceDetailActivity extends BaseActivity<ActivityDetailMkgw7Binding> {
    ...
    private final List<String> mScanDevices = new ArrayList<>();
    ...
    @Override
    protected ActivityDetailMkgw7Binding getViewBinding() {
        return ActivityDetailMkgw7Binding.inflate(getLayoutInflater());
    }
