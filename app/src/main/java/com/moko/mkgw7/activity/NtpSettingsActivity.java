...
import com.moko.mkgw7.databinding.ActivityNtpSettingsMkgw7Binding;
...
public class NtpSettingsActivity extends BaseActivity<ActivityNtpSettingsMkgw7Binding> {
                        ...
                        if (flag == 0x00) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_NTP_URL:
                                    ...
                                    mBind.etNtpServer.setSelection(mBind.etNtpServer.getText().length());
                                    break;
    ...
    @Override
    protected ActivityNtpSettingsMkgw7Binding getViewBinding() {
        return ActivityNtpSettingsMkgw7Binding.inflate(getLayoutInflater());
    }
