...
import com.moko.mkgw7.databinding.ActivityFilterUidMkgw7Binding;
...
public class FilterUIDActivity extends BaseActivity<ActivityFilterUidMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterUidMkgw7Binding getViewBinding() {
        return ActivityFilterUidMkgw7Binding.inflate(getLayoutInflater());
    }
