...
import com.moko.mkgw7.databinding.ActivityDuplicateDataFilterMkgw7Binding;
...
public class DuplicateDataFilterActivity extends BaseActivity<ActivityDuplicateDataFilterMkgw7Binding> {
    ...
    @Override
    protected ActivityDuplicateDataFilterMkgw7Binding getViewBinding() {
        return ActivityDuplicateDataFilterMkgw7Binding.inflate(getLayoutInflater());
    }
