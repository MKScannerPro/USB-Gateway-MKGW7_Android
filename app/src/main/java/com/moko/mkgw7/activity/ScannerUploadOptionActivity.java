...
import com.moko.mkgw7.activity.filter.FilterAdvNameActivity;
import com.moko.mkgw7.activity.filter.FilterMacAddressActivity;
import com.moko.mkgw7.activity.filter.FilterRawDataSwitchActivity;
...
public class ScannerUploadOptionActivity extends BaseActivity<ActivityScannerUploadOptionMkgw7Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerUploadOptionMkgw7Binding getViewBinding() {
        return ActivityScannerUploadOptionMkgw7Binding.inflate(getLayoutInflater());
    }
    ...
    private void onFilterPhyClick() {
        ...
        dialog.setDatas(Arrays.asList(phyArr), phySelected);
