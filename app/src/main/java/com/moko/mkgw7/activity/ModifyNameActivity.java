...
public class ModifyNameActivity extends BaseActivity<ActivityModifyDeviceNameMkgw7Binding> {
    ...
    @Override
    protected ActivityModifyDeviceNameMkgw7Binding getViewBinding() {
        return ActivityModifyDeviceNameMkgw7Binding.inflate(getLayoutInflater());
    }
