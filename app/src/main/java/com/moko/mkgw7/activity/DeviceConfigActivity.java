...
public class DeviceConfigActivity extends BaseActivity<ActivityDeviceConfigMkgw7Binding> {
    ...
    @Override
    protected ActivityDeviceConfigMkgw7Binding getViewBinding() {
        return ActivityDeviceConfigMkgw7Binding.inflate(getLayoutInflater());
    }
