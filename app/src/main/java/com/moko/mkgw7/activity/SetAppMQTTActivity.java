...
public class SetAppMQTTActivity extends BaseActivity<ActivityMqttAppMkgw7Binding> implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate() {
        ...
        expertFilePath = MkGw7MainActivity.PATH_LOGCAT + File.separator + "export" + File.separator + "Settings for APP.xlsx";
    }

    @Override
    protected ActivityMqttAppMkgw7Binding getViewBinding() {
        return ActivityMqttAppMkgw7Binding.inflate(getLayoutInflater());
    }
