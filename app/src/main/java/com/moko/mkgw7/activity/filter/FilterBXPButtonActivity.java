...
import com.moko.mkgw7.databinding.ActivityFilterBxpButtonMkgw7Binding;
...
public class FilterBXPButtonActivity extends BaseActivity<ActivityFilterBxpButtonMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterBxpButtonMkgw7Binding getViewBinding() {
        return ActivityFilterBxpButtonMkgw7Binding.inflate(getLayoutInflater());
    }
