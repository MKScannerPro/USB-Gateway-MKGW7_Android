...
import com.moko.mkgw7.databinding.ActivityFilterUrlMkgw7Binding;
...
public class FilterUrlActivity extends BaseActivity<ActivityFilterUrlMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterUrlMkgw7Binding getViewBinding() {
        return ActivityFilterUrlMkgw7Binding.inflate(getLayoutInflater());
    }
