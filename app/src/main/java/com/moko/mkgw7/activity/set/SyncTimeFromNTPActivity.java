...
import com.moko.mkgw7.databinding.ActivitySyncFromNtpMkgw7Binding;
...
public class SyncTimeFromNTPActivity extends BaseActivity<ActivitySyncFromNtpMkgw7Binding> {
    ...
    @Override
    protected ActivitySyncFromNtpMkgw7Binding getViewBinding() {
        return ActivitySyncFromNtpMkgw7Binding.inflate(getLayoutInflater());
    }
