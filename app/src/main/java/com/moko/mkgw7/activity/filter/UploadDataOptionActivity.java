...
import com.moko.mkgw7.databinding.ActivityUploadDataOptionMkgw7Binding;
...
public class UploadDataOptionActivity extends BaseActivity<ActivityUploadDataOptionMkgw7Binding> {
    ...
    @Override
    protected ActivityUploadDataOptionMkgw7Binding getViewBinding() {
        return ActivityUploadDataOptionMkgw7Binding.inflate(getLayoutInflater());
    }
