...
import com.moko.mkgw7.databinding.ActivityFilterOtherMkgw7Binding;
...
public class FilterOtherActivity extends BaseActivity<ActivityFilterOtherMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterOtherMkgw7Binding getViewBinding() {
        return ActivityFilterOtherMkgw7Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_OTHER) {
            ...
            if (number > 0) {
                ...
                for (JsonElement jsonElement : ruleList) {
                    ...
                    View v = LayoutInflater.from(this).inflate(R.layout.item_other_filter_mkgw7, mBind.llFilterCondition, false);
