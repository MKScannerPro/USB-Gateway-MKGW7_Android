...
import com.moko.mkgw7.databinding.ActivityAdvertiseIbeaconMkgw7Binding;
 ...
 * @des:
 */
public class AdvertiseIBeaconActivity extends BaseActivity<ActivityAdvertiseIbeaconMkgw7Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityAdvertiseIbeaconMkgw7Binding getViewBinding() {
        return ActivityAdvertiseIbeaconMkgw7Binding.inflate(getLayoutInflater());
    }
