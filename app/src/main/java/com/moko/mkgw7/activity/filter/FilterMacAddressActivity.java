...
import com.moko.mkgw7.databinding.ActivityFilterMacMkgw7Binding;
...
public class FilterMacAddressActivity extends BaseActivity<ActivityFilterMacMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterMacMkgw7Binding getViewBinding() {
        return ActivityFilterMacMkgw7Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_MAC_ADDRESS) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterMacAddressActivity.this).inflate(R.layout.item_mac_address_filter_mkgw7, mBind.llMacAddress, false);
                    TextView title = v.findViewById(R.id.tv_mac_address_title);
                    EditText etMacAddress = v.findViewById(R.id.et_mac_address);
                    title.setText(String.format(Locale.getDefault(),"MAC %d", index));
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.item_mac_address_filter_mkgw7, mBind.llMacAddress, false);
        TextView title = v.findViewById(R.id.tv_mac_address_title);
        title.setText(String.format(Locale.getDefault(),"MAC %d", count + 1));
        mBind.llMacAddress.addView(v);
    }
