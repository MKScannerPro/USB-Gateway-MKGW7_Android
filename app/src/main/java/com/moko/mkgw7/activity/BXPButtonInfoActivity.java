...
public class BXPButtonInfoActivity extends BaseActivity<ActivityBxpButtonInfoMkgw7Binding> {
    ...
    protected void onCreate() {
        ...
        mBind.tvBatteryVoltage.setText(String.format(Locale.getDefault(), "%dmV", mBXPButtonInfo.battery_v));
    ...
    @Override
    protected ActivityBxpButtonInfoMkgw7Binding getViewBinding() {
        return ActivityBxpButtonInfoMkgw7Binding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_BXP_BUTTON_STATUS) {
            ...
            mBind.tvBatteryVoltage.setText(String.format(Locale.getDefault(), "%dmV", bxpButtonInfo.battery_v));
