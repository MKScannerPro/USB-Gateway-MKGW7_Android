...
import com.moko.mkgw7.databinding.ActivityFilterTlmMkgw7Binding;
...
public class FilterTLMActivity extends BaseActivity<ActivityFilterTlmMkgw7Binding> {
    ...
    @Override
    protected ActivityFilterTlmMkgw7Binding getViewBinding() {
        return ActivityFilterTlmMkgw7Binding.inflate(getLayoutInflater());
    }
