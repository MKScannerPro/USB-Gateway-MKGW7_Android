...
import com.moko.mkgw7.databinding.ActivityScannerFilterMkgw7Binding;
...
public class ScannerFilterActivity extends BaseActivity<ActivityScannerFilterMkgw7Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerFilterMkgw7Binding getViewBinding() {
        return ActivityScannerFilterMkgw7Binding.inflate(getLayoutInflater());
    }
